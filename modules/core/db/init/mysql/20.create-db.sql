...
alter table PAXBASE_APP_USER_JOBFUNCTION_LINK add constraint FK_APPUSEJOB_JOBFUNCTION foreign key (JOBFUNCTION_ID) references PAXBASE_JOBFUNCTION(ID)^
alter table PAXBASE_APP_USER_JOBFUNCTION_LINK add constraint FK_APPUSEJOB_APP_USER foreign key (APP_USER_ID) references PAXBASE_APP_USER(ID)^
